    ...
    <header>
      <div className="header-container flex">
        ...
        <div onClick={() => toggleTheme(darkTheme)} role="button" className="theme-toggle flex gap-5px i-center">
          {darkTheme ?
          <>
            <span style={{borderLeft: '2px solid var(--high-contrast)', paddingLeft: '5px'}}> Light</span>
          ...
          <>
            ...
            <span style={{borderRight: '2px solid var(--high-contrast)', paddingRight: '5px'}}>Dark</span>
          </>}
        </div>
      </div>
    </header>
